...
class TestDBStorage(unittest.TestCase):
    ...
    @unittest.skipIf(models.storage_t != 'db', "not testing db storage")
    def test_save(self):
        """Tests method for obtaining an instance db  to storage"""
        storage = models.storage

        storage.reload()

        state_data = {"name": "haway"}
    ...
    def test_save(self):
        ...
        storage = models.storage
        storage.reload()
        state_data = {"name": "senegal"}
        state_instance = State(**state_data)
        storage.new(state_instance)

        city_data = {"name": "fes", "state_id": state_instance.id}
